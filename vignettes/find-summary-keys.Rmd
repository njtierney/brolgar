...
And we want to know those `keys` that are **nearest** to some set of summary
statistics of the slope. Let's say the _five number summary_:
...
statistics. In this case, it is the five number summary, which is a list of 
functions, given by `l_five_num`. But you could provide your own list of functions.
