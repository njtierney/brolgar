...
We can combine this with `sample_n_keys()` to filter those with at least 5 observations using `add_n_obs()` and `filter()`. This provides us with 20 people with at least 5 observations.
