...
vignette: >
  %\VignetteIndexEntry{finding-features}
...
We can calculate `features` of longitudinal data using the `features` function (from [`fabletools`](http://fabletools.tidyverts.org/), made available in `brolgar`).
