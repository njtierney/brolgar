...
### Quick helper functions
  ...
  - `key_slope()` Intercept and slope estimate for each key, given some linear model formula.

For example, we can calculate the number of observations with `n_key_obs()`:
