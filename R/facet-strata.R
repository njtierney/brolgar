...
facet_strata <- function(
  ...
  ggproto(NULL, FacetStrata, shrink = shrink, params = facet$params)
}
...
FacetStrata <- ggproto(
  ...
  compute_layout = function(data, params) {
    id <- seq_len(params$n)
    dims <- wrap_dims(n = params$n, nrow = params$nrow, ncol = params$ncol)
  ...
  map_data = function(data, layout, params) {
    ...
    new_data <- brolgar::stratify_keys(
      .data = data,
      n_strata = params$n,
      along = !!params$along,
      fun = params$fun
