...
#'     to 1990 dollars.}
#'   \item{experience}{length of time in the workforce (in years). This is
#'     treated as the time variable, with t0 for each subject starting on 
#'     their first day at work. The number of time points and values of time
